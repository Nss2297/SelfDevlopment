...
@EnableJpaRepositories(entityManagerFactoryRef = "MDSSEntityManagerFactory",
    transactionManagerRef = "MDSSTransactionManager", basePackages = {"com.waseel.pbm.rtsservice.repository.mdss"})
...
public class MDSSDataConfiguration {
	  ...
	  public LocalContainerEntityManagerFactoryBean mdssEntityManagerFactory(
	    ...
	    return builder.dataSource(dataSource).packages("com.waseel.pbm.rtsservice.persist.mdss").persistenceUnit("mdss")
	        .build();
	  }
