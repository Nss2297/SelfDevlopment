...
public class DrugFormularyDetails implements Serializable {
	...
	public DrugFormularyDetails(Long drugFormularyDetailsId, Long formularyId, Long waseelDrugId,
	...
	public DrugFormularyDetails(Long formularyId, Long waseelDrugId, String registrationNumber, String tradeName,
			String scientificName, String scientificCode, BigDecimal price, Date lastUpdateDate) {
		this.formularyId = formularyId;
		this.waseelDrugId = waseelDrugId;
		this.registrationNumber = registrationNumber;
		this.tradeName = tradeName;
