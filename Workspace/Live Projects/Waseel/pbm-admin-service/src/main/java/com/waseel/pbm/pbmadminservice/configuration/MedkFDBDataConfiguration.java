...
@EnableJpaRepositories(entityManagerFactoryRef = "MedkFDBEntityManagerFactory", basePackages = {
        "com.waseel.pbm.pbmadminservice.repository.medkfdb"})
public class MedkFDBDataConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean medkFDBEntityManagerFactory(
            EntityManagerFactoryBuilder builder, @Qualifier("MedkFDBDataSource")
            DataSource dataSource) {
        return builder.dataSource(dataSource).packages("com.waseel.pbm.pbmadminservice.persist.medkfdb")
