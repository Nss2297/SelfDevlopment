package com.waseel.pbm.pbmadminservice.persist.hira;
...
public class SwitchAccount implements java.io.Serializable {
	...
	public SwitchAccount(BigDecimal switchAccountId, String name, String arabicName, String category, String code,
			Double payerCategory, String isEnabled) {
