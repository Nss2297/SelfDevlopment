...
@EnableJpaRepositories(entityManagerFactoryRef = "MDSSEntityManagerFactory",
        transactionManagerRef = "MDSSTransactionManager",
        basePackages = {"com.waseel.prescription.repository.mdss"})
...
public class MDSSDataConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean mdssEntityManagerFactory(
        ...
        return builder.dataSource(dataSource).packages("com.waseel.prescription.persist.mdss",
                        "com.waseel.prescription.persist.businessrules")
                .persistenceUnit("mdss").build();
    }
