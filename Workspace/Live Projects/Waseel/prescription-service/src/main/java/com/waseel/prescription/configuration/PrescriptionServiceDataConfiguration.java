...
@EnableJpaRepositories(entityManagerFactoryRef = "PrescriptionServiceEntityManagerFactory",
        ...
        "com.waseel.prescription.repository.prescriptionservice"})
public class PrescriptionServiceDataConfiguration {
    ...
    LocalContainerEntityManagerFactoryBean prescriptionServiceEntityManagerFactory(EntityManagerFactoryBuilder builder,
                                                                                   @Qualifier("PrescriptionServiceDataSource")
                                                                                           DataSource dataSource) {
        return builder.dataSource(dataSource)
                .packages("com.waseel.prescription.persist.prescriptionservice",
                        "com.waseel.prescription.persist.hira",
                        "com.waseel.prescription.persist.businessrules",
                        "com.waseel.prescription.persist.mdss")
