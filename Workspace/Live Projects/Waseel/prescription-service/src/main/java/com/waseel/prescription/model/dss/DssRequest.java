...
public class DssRequest {
	...
	public List<DssDrugList> drugList = null;
	...
	public void setMemberId(String memberId) {
		this.memberId = !StringUtils.isBlank(memberId)? memberId.trim() : memberId;
	}
	...
	@JsonProperty("drugList")
	public List<DssDrugList> getDrugList() {
		return drugList;
	}

	@JsonProperty("drugList")
	public void setDrugList(List<DssDrugList> drugList) {
