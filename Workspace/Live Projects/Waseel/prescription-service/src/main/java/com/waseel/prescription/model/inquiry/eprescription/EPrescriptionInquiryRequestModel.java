...
public class EPrescriptionInquiryRequestModel {
	...
	public EPrescriptionInquiryRequestModel() {
		super();
	}

	public EPrescriptionInquiryRequestModel(String requestType, String caseType, String ePrescriptionReferenceNumber,
			String ePrescriptionStatus, String ePrescriptionStatusDescription, String payerId, String providerId,
			String memberName, Long idNumber, Date dateOfBirth, String policyNumber, String memberGender,
			BigDecimal memberWeight, BigDecimal memberHeight, String physicianLicenseNumber, String physicianSpeciality,
			String physicianName, String physicianCategory, boolean canCancel, boolean canFollowUp,
			BigDecimal totalPrescriptionPrice, BigDecimal totalPatientShareValue, String totalPatientShareCurrency,
			BigDecimal totalPayerShareValue, String totalPayerShareCurrency, List<DiagnosisCodes> diagnosisCodes,
			List<EPrescriptionInquiryDrugList> drugList) {
		super();
		this.requestType = requestType;
		this.caseType = caseType;
		this.ePrescriptionReferenceNumber = ePrescriptionReferenceNumber;
