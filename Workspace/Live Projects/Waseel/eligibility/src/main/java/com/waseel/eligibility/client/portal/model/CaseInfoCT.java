...
/**
 * <p>Java class for CaseInfoCT complex type.
 * 
 ...
 *                   &lt;element name="height" type="{http://www.waseel.com/wsdl/primary/wschema}heightST"/&gt;
...
@XmlType(name = "CaseInfoCT", propOrder = {
    "caseType",
    "physician",
    "patient",
    "caseDescription",
...
public class CaseInfoCT {
     ...
     * @return
     *     possible object is
     *     {@link CaseInfoCT.CaseDescription }
     *     
     */
    ...
    public static class CaseDescription {
         ...
         *     
         */
        public void setIllnessCategory(CaseInfoCT.CaseDescription.IllnessCategory value) {
        ...
        public static class IllnessCategory {
             ...
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the inllnessCode property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
			...
			public void setInllnessCode(List<IllnessCodeST> inllnessCode) {
				this.inllnessCode = inllnessCode;
			}
