...
/**
 * <p>Java class for ClaimResponseCT complex type.
 * 
...
@XmlType(name = "ClaimResponseCT", propOrder = {
    "claimIdentifier",
    "memberInfo",
    "submissionDate",
    "status",
...
public class ClaimResponseCT {
    ...
    public void setInvoiceResponse(List<InvoiceResponseCT> invoiceResponse) {
