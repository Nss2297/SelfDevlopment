...
public class DuplicateTherapyResponseModel {
	...
	public DuplicateTherapyResponseModel() {
	}

	public DuplicateTherapyResponseModel(Long id, String serviceCode, String interactedServiceCode, String payerId,
			String serviceStatus, String moduleName, String additionalRejectionReason,
			Date lastUpdateDateAndTime, String scientificCode) {
		this.id = id;
