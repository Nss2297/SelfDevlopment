...
@Entity
@Table(name = "`PCDrugToDrug`", schema = "`MDSS`")
public class PcDrugToDrug implements Serializable {
	...
	public PcDrugToDrug(PCDrugCommonId id, String serviceStatus, String additionalRejectionReason) {
		super();
		this.id = id;
