...
public class PcDrugToDrugRequestModel {
	...
	public PcDrugToDrugRequestModel() {}
	
	public PcDrugToDrugRequestModel(String serviceCode, String interactedServiceCode, String payerId,
	...
	public PcDrugToDrugRequestModel(
			@NotEmpty(message = "ServiceCode {emptyDataValidation}") @NoMoreThan250Length(message = "ServiceCode {noMoreThan250LengthValidation}") String serviceCode,
			@NotEmpty(message = "InteractedServiceCode {emptyDataValidation}") @NoMoreThan250Length(message = "InteractedServiceCode {noMoreThan250LengthValidation}") String interactedServiceCode,
			@NoMoreThan20Length(message = "PayerId {noMoreThan20LengthValidation}") String payerId,
			@IsValidModuleName(message = "{moduleNameValidation}") String moduleName,
			@IsValidServiceStatus(message = "{serviceStatusValidation}") String serviceStatus,
			@NoMoreThan500Length(message = "AdditionalRejectionReason {noMoreThan500LengthValidation}") String additionalRejectionReason,
    ...
    public boolean equals(Object obj) {
        ...
        PcDrugToDrugRequestModel other = (PcDrugToDrugRequestModel) obj;
