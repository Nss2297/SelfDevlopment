...
public class OverrideRequestService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(OverrideRequestService.class);
	...
	public CancelOverrideResponse manageOverrideRequest(CancellationOverrideRequest overrideRequest,
		...
		if (tranLog != null) {
			...
			response = dssDataManipulationService.validateOverrideRequest(overrideRequest);
			LOGGER.info("Data saved in TransactionLog table for Override Request. TransactionLogId is "
