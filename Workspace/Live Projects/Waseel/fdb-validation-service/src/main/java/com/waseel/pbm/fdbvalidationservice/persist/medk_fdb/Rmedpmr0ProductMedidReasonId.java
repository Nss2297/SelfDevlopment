...
/**
 * Rmedpmr0ProductMedidReasonId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class Rmedpmr0ProductMedidReasonId  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rmedpmr0ProductMedidReasonId() {
    }

    
    /** full constructor */
    public Rmedpmr0ProductMedidReasonId(Integer productId, Timestamp productionDate, Short moveReasonCd) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Rmedpmr0ProductMedidReasonId) ) return false;
		 Rmedpmr0ProductMedidReasonId castOther = ( Rmedpmr0ProductMedidReasonId ) other; 
