...
/**
 * Rfmlisr1IcdSearchId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class Rfmlisr1IcdSearchId  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rfmlisr1IcdSearchId() {
    }

    
    /** full constructor */
    public Rfmlisr1IcdSearchId(String searchIcdCd, String icdCdType, Integer relatedDxid, String fmlClinCode) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Rfmlisr1IcdSearchId) ) return false;
		 Rfmlisr1IcdSearchId castOther = ( Rfmlisr1IcdSearchId ) other; 
