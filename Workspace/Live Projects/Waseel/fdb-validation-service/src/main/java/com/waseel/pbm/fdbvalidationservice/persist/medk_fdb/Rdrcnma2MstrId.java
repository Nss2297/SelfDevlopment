...
/**
 * Rdrcnma2MstrId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class Rdrcnma2MstrId  implements java.io.Serializable {
    ...
    // Fields    
     ...
     private Integer lowCurrentWeightGrams;
     private Integer highCurrentWeightGrams;


    // Constructors

    /** default constructor */
    public Rdrcnma2MstrId() {
    }

    
    /** full constructor */
    public Rdrcnma2MstrId(Integer gcnSeqno, String dr2Rt, Integer dr2Loaged, Integer dr2Hiaged, String fdbdx, String dr2Dostpi, Byte neomLowGestBirthAgeWeeks, Byte neomHighGestBirthAgeWeeks, Integer lowCurrentWeightGrams, Integer highCurrentWeightGrams) {
        ...
        this.lowCurrentWeightGrams = lowCurrentWeightGrams;
        this.highCurrentWeightGrams = highCurrentWeightGrams;
    }
    ...
    @Column(name="LOW_CURRENT_WEIGHT_GRAMS", nullable=false, precision=6, scale=0)

    public Integer getLowCurrentWeightGrams() {
        return this.lowCurrentWeightGrams;
    }
    
    public void setLowCurrentWeightGrams(Integer lowCurrentWeightGrams) {
        this.lowCurrentWeightGrams = lowCurrentWeightGrams;
    }

    @Column(name="HIGH_CURRENT_WEIGHT_GRAMS", nullable=false, precision=6, scale=0)

    public Integer getHighCurrentWeightGrams() {
        return this.highCurrentWeightGrams;
    }
    
    public void setHighCurrentWeightGrams(Integer highCurrentWeightGrams) {
        this.highCurrentWeightGrams = highCurrentWeightGrams;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Rdrcnma2MstrId) ) return false;
		 Rdrcnma2MstrId castOther = ( Rdrcnma2MstrId ) other; 
 ...
 && ( (this.getLowCurrentWeightGrams()==castOther.getLowCurrentWeightGrams()) || ( this.getLowCurrentWeightGrams()!=null && castOther.getLowCurrentWeightGrams()!=null && this.getLowCurrentWeightGrams().equals(castOther.getLowCurrentWeightGrams()) ) )
 && ( (this.getHighCurrentWeightGrams()==castOther.getHighCurrentWeightGrams()) || ( this.getHighCurrentWeightGrams()!=null && castOther.getHighCurrentWeightGrams()!=null && this.getHighCurrentWeightGrams().equals(castOther.getHighCurrentWeightGrams()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getLowCurrentWeightGrams() == null ? 0 : this.getLowCurrentWeightGrams().hashCode() );
         result = 37 * result + ( getHighCurrentWeightGrams() == null ? 0 : this.getHighCurrentWeightGrams().hashCode() );
         return result;
   }   
