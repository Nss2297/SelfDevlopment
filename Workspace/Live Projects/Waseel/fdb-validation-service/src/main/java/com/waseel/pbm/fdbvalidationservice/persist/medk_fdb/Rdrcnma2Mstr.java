...
/**
 * Rdrcnma2Mstr entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="RDRCNMA2_MSTR"
    ,schema="MEDK_FDB"
)

public class Rdrcnma2Mstr  implements java.io.Serializable {


    // Fields    

     private Rdrcnma2MstrId id;
     private String neomGestBirthAgeReqInd;
     private String weightReqInd;
	...
	/** minimal constructor */
    public Rdrcnma2Mstr(Rdrcnma2MstrId id, Double nteSingleDose, String nteSingleDoseUnitCode, Short dosingAgeSourceId) {
        this.id = id;
    ...
    @AttributeOverrides( {
        ...
        @AttributeOverride(name="lowCurrentWeightGrams", column=@Column(name="LOW_CURRENT_WEIGHT_GRAMS", nullable=false, precision=6, scale=0) ), 
        @AttributeOverride(name="highCurrentWeightGrams", column=@Column(name="HIGH_CURRENT_WEIGHT_GRAMS", nullable=false, precision=6, scale=0) ) } )

    public Rdrcnma2MstrId getId() {
        return this.id;
    }
    
    public void setId(Rdrcnma2MstrId id) {
        this.id = id;
    }
    ...
    @Column(name="WEIGHT_REQ_IND", length=1)

    public String getWeightReqInd() {
        return this.weightReqInd;
    }
    
    public void setWeightReqInd(String weightReqInd) {
        this.weightReqInd = weightReqInd;
    }
    ...
    @Column(name="DR2_LOFREQ", precision=5, scale=3)
    ...
    @Column(name="DR2_HIFREQ", precision=5, scale=3)
