...
public class Ripdat0ProductAttributeId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Ripdat0ProductAttributeId) ) return false;
 ...
 && ( (this.getProductAttributeCode()==castOther.getProductAttributeCode()) || ( this.getProductAttributeCode()!=null && castOther.getProductAttributeCode()!=null && this.getProductAttributeCode().equals(castOther.getProductAttributeCode()) ) )
 && ( (this.getProductAttributeSeq()==castOther.getProductAttributeSeq()) || ( this.getProductAttributeSeq()!=null && castOther.getProductAttributeSeq()!=null && this.getProductAttributeSeq().equals(castOther.getProductAttributeSeq()) ) );
   }
