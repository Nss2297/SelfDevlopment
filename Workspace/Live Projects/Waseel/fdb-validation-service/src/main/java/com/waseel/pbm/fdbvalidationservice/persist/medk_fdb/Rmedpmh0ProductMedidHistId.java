...
/**
 * Rmedpmh0ProductMedidHistId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class Rmedpmh0ProductMedidHistId  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rmedpmh0ProductMedidHistId() {
    }

    
    /** full constructor */
    public Rmedpmh0ProductMedidHistId(Integer productId, Timestamp productionDate) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Rmedpmh0ProductMedidHistId) ) return false;
		 Rmedpmh0ProductMedidHistId castOther = ( Rmedpmh0ProductMedidHistId ) other; 
