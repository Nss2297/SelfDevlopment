...
/**
 * Rmedpmh0ProductMedidHist entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="RMEDPMH0_PRODUCT_MEDID_HIST"
    ,schema="MEDK_FDB"
)

public class Rmedpmh0ProductMedidHist  implements java.io.Serializable {


    // Fields    

     private Rmedpmh0ProductMedidHistId id;
    ...
    /** default constructor */
    public Rmedpmh0ProductMedidHist() {
    }

	/** minimal constructor */
    public Rmedpmh0ProductMedidHist(Rmedpmh0ProductMedidHistId id, Integer prevMedid, String prevMedidNameSourceCd, String prevMedidOldStatusCd, String prevMedidNewStatusCd, String prevMedidDesc, Integer currMedid, String currMedidNameSourceCd, String currMedidNewStatusCd, String currMedidDesc) {
        this.id = id;
    ...
    /** full constructor */
    public Rmedpmh0ProductMedidHist(Rmedpmh0ProductMedidHistId id, Integer prevMedid, String prevMedidNameSourceCd, String prevMedidOldStatusCd, String prevMedidNewStatusCd, String prevMedidDesc, Integer currMedid, String currMedidNameSourceCd, String currMedidOldStatusCd, String currMedidNewStatusCd, String currMedidDesc) {
        this.id = id;
        this.prevMedid = prevMedid;
        this.prevMedidNameSourceCd = prevMedidNameSourceCd;
        this.prevMedidOldStatusCd = prevMedidOldStatusCd;
    ...
    public Rmedpmh0ProductMedidHistId getId() {
        return this.id;
    }
    
    public void setId(Rmedpmh0ProductMedidHistId id) {
        this.id = id;
    }
