...
@EnableJpaRepositories(entityManagerFactoryRef = "MDSSEntityManagerFactory",
        transactionManagerRef = "MDSSTransactionManager", basePackages = {"com.waseel.pbm.fdbvalidationservice.repository.mdss"})
...
public class MDSSDataConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean mdssEntityManagerFactory(
        ...
        return builder.dataSource(dataSource).packages("com.waseel.pbm.fdbvalidationservice.persist.mdss").persistenceUnit("mdss")
                .build();
    }
