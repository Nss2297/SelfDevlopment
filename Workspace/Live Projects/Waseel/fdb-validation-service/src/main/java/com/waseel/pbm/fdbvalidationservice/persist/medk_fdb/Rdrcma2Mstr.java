...
/**
 * Rdrcma2Mstr entity. @author MyEclipse Persistence Tools
 */
@Entity
...
public class Rdrcma2Mstr  implements java.io.Serializable {


    // Fields    

     private Rdrcma2MstrId id;
	...
	/** minimal constructor */
    public Rdrcma2Mstr(Rdrcma2MstrId id, Double nteSingleDose, String nteSingleDoseUnitCode, Short dosingAgeSourceId) {
        this.id = id;
    ...
    public Rdrcma2MstrId getId() {
        return this.id;
    }
    
    public void setId(Rdrcma2MstrId id) {
        this.id = id;
    }
