...
public class Test114 {
    private static int[] populateArray(int size, int startIndex, int[] array) {
    ...
    private static void merge(int low, int high, int median, int[] array) {
        int[] leftArray = populateArray(median - low, low, array);
        int[] rightArray = populateArray(high - median + 1, median + 1, array);
        int leftPnt = 0;
        int rightPnt = 0;
        int pnt = low;
