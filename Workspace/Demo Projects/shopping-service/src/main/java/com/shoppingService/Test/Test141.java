...
public class Test141 {
    private static void swap(int num1Index, int num2Index, int[] orignalArray) {
        int temp = orignalArray[num1Index];
        orignalArray[num1Index] = orignalArray[num2Index];
        orignalArray[num2Index] = temp;
    }
