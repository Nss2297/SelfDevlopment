...
public class Test368 {
    private static int[] populatArray(int size, int startIndex, int[] orignalArray) {
    ...
    private static void merge(int low, int hign, int median, int[] array) {
        int[] leftArray = populatArray(median - low + 1, low, array);
        int[] rightArray = populatArray(hign - median, median + 1, array);
        int leftPnt = 0;
        int rightPnt = 0;
        int pnt = low;
