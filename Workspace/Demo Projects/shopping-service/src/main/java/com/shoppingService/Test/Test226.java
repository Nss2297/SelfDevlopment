...
public class Test226 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Pow(-1.00000, 2147483647)=" + myPow(-1.00000, 2147483647));
        System.out.println("Pow(-1.00000, 0)=" + myPow(-1.00000, 0));
        System.out.println("Pow(185514.00000, 0)=" + myPow(185514.00000, 0));
        System.out.println("Pow(-1.00000, 1)=" + myPow(-1.00000, 1));
    }
}
